...
namespace MdU { 
    ...
    inline std::string toString(int64_t)
    {
        return "int64_t";
    }
    inline std::string toString(uint64_t)
    {
        return "int64_t";
    }
    inline std::string toString(int32_t)
    {
        return "int64_t";
    }
    inline std::string toString(uint32_t)
    {
        return "int64_t";
    }
    inline std::string toString(double, bool decimal = false)
    {
        return "int64_t";
    }
