...
// virtual function 
void GlShdLine:: initLocation() 
{
    //---get attribute locations
    m_a_pos_normalLoc = MDGL_CHECK(md::glGetAttribLocation(m_progId, "a_pos_normal"));
    m_a_dataLoc = MDGL_CHECK(md::glGetAttribLocation(m_progId, "a_data"));

    //---get uniform locations
    m_u_matrixLoc = MDGL_CHECK(md::glGetUniformLocation(m_progId, "u_matrix"));
    m_u_ratioLoc  = MDGL_CHECK(md::glGetUniformLocation(m_progId, "u_ratio"));
    m_u_units_to_pixelsLoc = MDGL_CHECK(md::glGetUniformLocation(m_progId, "u_units_to_pixels"));
    m_u_device_pixel_ratioLoc = MDGL_CHECK(md::glGetUniformLocation(m_progId, "u_device_pixel_ratio "));
} 
void GlShdLine::enableVertexAttrib()
{
