...
#if !defined(OsID_IOS) && defined(OsID_MAC)
...
void (* const glDrawPixels)(GLsizei, GLsizei, 
                    GLenum, GLenum, 
					const GLvoid *) = ::glDrawPixels;
...
/*
#if !OsID_IOS && OsID_MAC
void (* const glDepthRangef)(GLfloat, 
       GLfloat) = [](GLfloat nearVal, GLfloat farVal) 
{ 
