...
using value_base = 
            mapbox::util::variant<null_value_t, 
                                  bool, 
                                  uint64_t, 
                                  int64_t, 
                                  double, 
...
using identifier = mapbox::util::variant<null_value_t, 
                                         uint64_t, 
                                         int64_t, 
                                         double, 
                                         std::string>;
...
template <class T>
constexpr bool operator==(feature<T> const& lhs, 
                          feature<T> const& rhs
                          )
{
